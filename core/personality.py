...
class PersonalityManager:
    ...
    def generate_system_prompt(self) -> str:
        ...
        tool_guardrail = (
            ...
            "  • Use deep_research (preferred) for ANY question involving: the latest or newest "
            "product, model, version, release, price, announcement, review, or recent news. "
            "Keywords like 'latest', 'newest', 'current', 'recent', 'just released', "
            "'best right now' are strong signals to call deep_research.\n"
            "  • Use web_search only for quick single-fact lookups (e.g. current time in a city, "
            "current weather, a specific URL).\n"
            "  • NEVER answer questions about product models, software versions, prices, "
            "hardware specs, or news from your training memory alone — your knowledge is out of "
            "date. Always call a tool.\n"
