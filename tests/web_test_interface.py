...
**Result:** {'✅ Rolling worked correctly!' if memory.message_count() <= max_window else '❌ Window size exceeded!'}
        """
...
**Results:**
- System message preserved: {'✅ Yes' if has_system else '❌ No'}
...
**Result:** {'✅ Clear worked correctly!' if after_count == 0 and has_system else '❌ Issue detected!'}
        """
    ...
    with gr.Blocks(
        ...
        **Note:** This interface uses a **mocked LLM backend** for testing purposes. 
        ...
        with gr.Tabs():
            ...
            # Tab 2: Tool Testing
            with gr.Tab("🛠️ Tool Testing"):
                gr.Markdown("### Test individual MCP tools")

                with gr.Row():
                    with gr.Column():
                        gr.Markdown("#### 🕐 get_current_time()")
            ...
            with gr.Tab("ℹ️ System Info"):
                ...
                **Test Mode:** Mock LLM Backend
                ...
                |-----------|--------|-------|
                | RollingMemory | ✅ Active | Rolling window working |
                | ChatEngine | ✅ Active | Using mock Ollama client |
                | get_current_time | ✅ Active | Returns system time |
                | web_search | ⚠️ Mock | Returns mock search results |
                | Ollama Connection | ⚠️ Mocked | Not connected to real Ollama |
